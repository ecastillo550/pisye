  ...
  <div class="col-12">
    ...
    <div class="col-4">
      <div class="form-group form-group-default required">
        ...
        <select name="subject_id" class="cs-select cs-skin-slide full-width" data-init-plugin="cs-select">
    ...
    <div class="col-4">
      <div class="form-group form-group-default required">
        ...
        <select name="level_id" class="cs-select cs-skin-slide full-width" data-init-plugin="cs-select">
    ...
    <div class="col-4">
      <div class="form-group form-group-default required">
        ...
        <select name="semester_id" class="cs-select cs-skin-slide full-width" data-init-plugin="cs-select">
    ...
    <div class="col-4">
      <div class="form-group form-group-default required">
        ...
        <select name="teacher_id" class="cs-select cs-skin-slide full-width" data-init-plugin="cs-select">
          @foreach($teachers as $teacher)
          <option value="{{ $teacher->id }}" {{ !empty($group) && ($group->teacher != null && $group->teacher->id == $teacher->id) ? 'selected' : ''  }}>{{ $teacher->name }}</option>
          @endforeach
        </select>
      </div>
    </div>
